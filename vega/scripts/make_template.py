...
def make_template(ini, out, fid_H0, fid_Ok, fid_wl, z_ref, no_extrap):
    minkh = 1.e-4
    maxkh = 1.1525e3
    npoints = 814
    ...
    out = fitsio.FITS(out, 'rw', clobber=True)
...
def main():
    ...
    make_template(
        args.ini, args.out, args.fid_H0, args.fid_Ok, args.fid_wl, args.z_ref, args.no_extrap)
