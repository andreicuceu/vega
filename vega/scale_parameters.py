...
class ScaleParameters:
    ...
    _parametrisations = ["ap_at", "aiso_epsilon", "phi_alpha", "aiso_aap"]
    ...
    def __init__(self, config):
        ...
        if self.metal_scaling and self.two_alpha_smooth:
            raise ValueError('The "metal-scaling" and "two-alpha-smooth" options are incompatible.')
    ...
    def get_ap_at(self, params, corr_name=None, metal_corr=False):
        ...
        if self.full_shape:
            return self.get_fullshape_params(
                params,
                corr_name,
            )
        elif params["peak"]:
    ...
    def get_fullshape_params(self, params, corr_name=None):
        ...
        if self.parametrisation != "phi_alpha" and not self.full_shape_alpha:
            raise ValueError(
                'Only the "phi_alpha" parametrisation works with split full-shape. '
