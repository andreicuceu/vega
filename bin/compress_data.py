...
using a Vega config file for the fiducial model, will output a compressed data vector. Note, compression type depends on the argument 'compression-type' in the config file.
