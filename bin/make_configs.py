...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--zeff", type=float, default=None, required=False, help="Effective redshift"
    )

    parser.add_argument(
        "--sampler", type=bool, default=False, required=False, help="Run the sampler."
    )
    ...
    parser.add_argument(
        ...
        required=False,
        help=(
            "Names of metals to include. Choose from [all, SiII(1190),"
    ...
    parser.add_argument(
        "--template",
        type=str,
        default="PlanckDR16/PlanckDR16.fits",
        required=False,
        help="Path to the template. Can be relative to Vega.",
    )
    ...
    parser.add_argument(
        "--full-shape", type=bool, default=False, required=False, help="Run full shape fit"
    )
    ...
    main_path = config_builder.build(
        correlations=correlations, fit_type=args.fit_name, fit_info=fit_info, out_path=args.out_path
    )
